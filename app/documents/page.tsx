  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="max-w-7xl mx-auto py-8 px-4">
        ...
        {documents.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 border border-white/10 rounded-2xl bg-white/5 backdrop-blur-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {documents.map((doc) => (
              <Card key={doc.id} className="flex flex-col h-full transition-all hover:shadow-xl hover:shadow-blue-500/10 bg-white/5 backdrop-blur-xl border-white/10 hover:bg-white/10 hover:scale-105">
                <CardHeader className="pb-3">
                  <div className="flex justify-between items-start space-x-2">
                    <div className="space-y-1 flex-1 min-w-0">
                      <CardTitle className="text-xl text-white line-clamp-1">{doc.title}</CardTitle>
                        ...
                        <div className="flex items-center min-w-0">
                          {doc.user.image && (
                            <img 
                              ...
                              className="w-5 h-5 rounded-full mr-2 flex-shrink-0 ring-1 ring-white/20"
                            />
                          )}
                ...
                <CardFooter className="border-t border-white/10 px-6 py-4 bg-white/5">
                  <Link href={`/openapi/${doc.id}`} className="w-full">
                    <Button variant="outline" className="w-full group bg-white/5 border-white/20 hover:bg-white/10 hover:border-white/30 text-white">
